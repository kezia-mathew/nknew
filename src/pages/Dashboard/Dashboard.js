                ...
                <div className="dashboard-left">
                    <div className="user-events">
                        ...
                        <div className="user">
                            ...
                            <div className="pfp">
                                {user.uid?<img id="userImage" src={user.photoURL} alt="" />:<i></i>}
                            </div>
                            <div className="user-info">
                                {isVerified?<h3 id="userName">{user.displayName}</h3>:checkUser()}
                            </div>
                    ...
                    <div className="campus-ambassador">
                        {isCA?<CAEvent/>:regCheck?<div id="confirmationBox">
                            Are you sure you want to become a Campus Ambassador
                            <button onClick={()=>setRegCheck(false)} id="cancelUser">Cancel</button>
                            <button onClick={makeUserCA} id="okUser">Ok</button>
                        </div>:<div id="registerBtn"><button id="registerUser" onClick={()=>setRegCheck(true)} >Register Now</button></div>}
                    </div>
